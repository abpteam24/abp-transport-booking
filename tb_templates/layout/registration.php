<?php
    ...
    add_action('abptb_registration_template', function ($post_infos, $form_data = []) {
        if (!empty($post_infos)) {
                ...
                <form action="" method="post" class="<?php echo esc_attr($double_route); ?>">
                    ...
                    <?php if (!empty($double_route)) { ?>
                        <div class="booking_area return">
                            ...
                            <?php
                                if ($seat_type === 'ticket') {
                                    do_action('abptb_ticket_type', $post_infos, $return_data, 'return_');
                                } else {
                                    do_action('abptb_sp_type', $post_infos, $return_data, 'return_');
                                } ?>
                        </div>
                    <?php }
