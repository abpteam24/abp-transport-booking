<?php
	...
	add_action( 'abptb_slider_popup_template', function ( $abptb_slider, $img_ids, $popup_id = '' ) {
		$active_popup = ( $abptb_slider['visible_popup'] ?? 'on' ) ?: 'on';
		$indicator    = ( $abptb_slider['popup_image_indicator'] ?? 'on' ) ?: 'on';
        ...
        <div class="abp_popup" data-popup="<?php echo esc_attr( $popup_id ); ?>">
            <div class="popup_area abptb_slider">
