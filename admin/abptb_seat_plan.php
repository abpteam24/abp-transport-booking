        ...
        class ABPTB_Seat_Plan {
                    ...
                    <div class="group_setting">
                        <div class="ticket_configuration setting_item">
                            <div class="_fj_between_fa_center">
                                <h5 class="abp"><?php esc_html_e('Ticket Type List', 'abp-transport-booking'); ?></h5>
                        ...
                        <?php if (ABPTB_Function::on_off('sp')) { ?>
                            <div class="decor_configuration setting_item">
                                <div class="_fj_between_fa_center">
                                    <h5 class="abp"><?php esc_html_e('Others/Decor Item List', 'abp-transport-booking'); ?></h5>
            ...
            public function sp_list(): void {
                ...
                <div class="_fj_between_mar_b_xxs">
                    <h5 class="abp_text_nowrap_gap_xs">💺 <?php esc_html_e('Seat Plan', 'abp-transport-booking'); ?><sup class="_circle_icon_xs"><?php echo esc_html(ABPTB_Query::get_sp('', true)); ?></sup></h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="_group_content">
                                        <button type="button" class="_btn_light_theme_xxs" onclick="abptb_popup_open_global('view_sp','<?php echo esc_attr($sp_info['id'] ?? ''); ?>')" title="<?php echo esc_attr__('View : ', 'abp-transport-booking') . ' ' . esc_attr($sp_info['name'] ?? ''); ?>"><?php ABPTB_Static::svg('view_1'); ?></button>
                                        <button type="button" class="_btn_light_navy_blue_xxs" onclick="abptb_sp_add('<?php echo esc_attr($sp_info['id'] ?? ''); ?>','1')" title="<?php echo esc_attr__('Copy/Clone : ', 'abp-transport-booking') . ' ' . esc_attr($sp_info['name'] ?? ''); ?>"><?php ABPTB_Static::svg('clone_1'); ?></button>
                                        <button type="button" class="_btn_light_yellow_xxs" onclick="abptb_sp_add('<?php echo esc_attr($sp_info['id'] ?? ''); ?>')" title="<?php echo esc_attr__('Edit : ', 'abp-transport-booking') . ' ' . esc_attr($sp_info['name'] ?? ''); ?>"><?php ABPTB_Static::svg('edit'); ?></button>
                                        <button type="button" class="_btn_light_danger_xxs" onclick="abptb_sp_delete('<?php echo esc_attr($sp_info['id'] ?? ''); ?>')" title="<?php echo esc_attr__('Permanent Remove : ', 'abp-transport-booking') . ' ' . esc_attr($sp_info['name'] ?? ''); ?>"><?php ABPTB_Static::svg('close_1'); ?></button>
                                    </div>
                                </td>
                            </tr>
                        <?php } ?>
            ...
            public function add_sp(): void {
                ...
                <div class="sp_section_card_xs _p_relative">
                    ...
                    <div class="_divider_xxs"></div>
                    <div class="info_text ">
                        🖱 <strong class="abp"><?php esc_html_e('Drag Cells', 'abp-transport-booking'); ?></strong>→
                        <?php esc_html_e('to Clone/Copy & range select', 'abp-transport-booking'); ?>
                        <strong class="abp _mar_lr_xs"> | </strong>
                        <strong class="abp"><?php esc_html_e('Double-Click', 'abp-transport-booking'); ?></strong>→
                        <?php esc_html_e('to edit Row/Col Spanning in the Left Panel.', 'abp-transport-booking'); ?>
                        <strong class="abp _mar_lr_xs"> | </strong>
                        <strong class="abp"><?php esc_html_e('Ctrl+Click ', 'abp-transport-booking'); ?></strong>→
                        <?php esc_html_e('To particular Item select', 'abp-transport-booking'); ?>
                        <strong class="abp _mar_lr_xs"> | </strong>
                        <strong class="abp"><?php esc_html_e('Shift+Click', 'abp-transport-booking'); ?></strong>→
                    ...
                    <div class="_max_350_fd_column_gap_xs">
                        <div class="sp_section_card_xs _p_relative">
                            <label class="_f_equal">
                                <span class="abp_label"><?php esc_html_e('Plan Name', 'abp-transport-booking'); ?></span>
                            ...
                            <div class="_f_equal _fj_between">
                                <span class="abp_label"><?php esc_html_e('Bg Image', 'abp-transport-booking'); ?></span>
                                <?php do_action('abptb_image_selection', '', $bg_image, '.sp_canvas'); ?>
                            </div>
                            <div class="_divider_xxs"></div>
                            <div class="_fj_between">
                                <span class="abp_label"><?php esc_html_e('Bg Color', 'abp-transport-booking'); ?></span>
                                <label>
                        ...
                        <div class="sp_section_card_xs">
                            <div class="_fd_column">
                                <span class="abp_label_mar_b_xxs_text_center_color_burnt_orange"><?php esc_html_e('Dimension (Rows X Columns)', 'abp-transport-booking'); ?></span>
                                <div class="_group_content">
                        ...
                        <div class="sp_section_card_xs">
                            <span class="abp_label_mar_b_xxs_text_center_color_burnt_orange"><?php esc_html_e('Cell Width X Height X Gap X Radius in px', 'abp-transport-booking'); ?></span>
                            <div class="_group_content">
                            ...
                            <div class="span_control">
                                <div class="_divider_xxs"></div>
                                <span class="abp_label_mar_b_xxs_text_center_color_burnt_orange"><?php esc_html_e('Cell  Control (Cols × Rows x Text x Font size)', 'abp-transport-booking'); ?></span>
                                <div class="_group_content">
                        ...
                        <div class="sp_section_card_xs _group_content_f_equal">
                            <button type="button" class="_btn_active_xs" onclick="abptb_sp_save()"><?php ABPTB_Static::svg('save');
                                    esc_html_e('Save Seat Plan', 'abp-transport-booking'); ?></button>
                            <button type="button" class="_btn_warning_xs" onclick="abptb_sp_clear()"><?php ABPTB_Static::svg('close_1');
                ...
                <div class="sp_section_card_xs _w_300">
                    ...
                    <div class="_fj_between_f_equal">
                        ...
                        <?php if (!empty($bg_image)) {
                            ...
                            <span class="abp_label"><?php esc_html_e('None', 'abp-transport-booking'); ?></span>
                        <?php } ?>
                    </div>
                    <div class="_divider_xxs"></div>
                    <div class="_fj_between">
                    ...
                    <div class="_divider_xxs"></div>
                    <div class="_fj_between">
                        <span class="abp_label"><?php esc_html_e('Dimension Rows', 'abp-transport-booking'); ?></span>
                        <span class="abp_label"><?php echo esc_attr($others['row'] ?? ''); ?></span>
                    </div>
                    <div class="_divider_xxs"></div>
                    <div class="_fj_between">
                        <span class="abp_label"><?php esc_html_e('Dimension Columns', 'abp-transport-booking'); ?></span>
                        <span class="abp_label"><?php echo esc_attr($others['column'] ?? ''); ?></span>
                    </div>
                    <div class="_divider_xxs"></div>
                    <div class="_fj_between">
                        <span class="abp_label"><?php esc_html_e('Cell Width', 'abp-transport-booking'); ?></span>
                        <span class="abp_label"><?php echo esc_attr($others['width'] ?? 50); ?>PX</span>
                    </div>
                    <div class="_divider_xxs"></div>
                    <div class="_fj_between">
                        <span class="abp_label"><?php esc_html_e('Cell Height', 'abp-transport-booking'); ?></span>
                        <span class="abp_label"><?php echo esc_attr($others['height'] ?? 50); ?>PX</span>
                    </div>
                    <div class="_divider_xxs"></div>
                    <div class="_fj_between">
                        <h5 class="abp"><?php esc_html_e('Total Seat', 'abp-transport-booking'); ?></h5>
            ...
            public function color_control(): void {
                ...
                <div class="_group_content">
                    ...
                    <button type="button" class="_btn_light_default_xs" onclick="abptb_popup_open_global('color_control')"><?php ABPTB_Static::svg('edit'); ?><?php esc_html_e('Edit/Modify', 'abp-transport-booking'); ?></button>
                </div>
                <?php
            }
            public function add_color_control(): void {
                ...
                <div class="abp_form">
                    <div class="_fa_center_fj_between">
                        <h5 class="abp"><?php esc_html_e('Modify / Edit Seat Plan Seat Color Combination', 'abp-transport-booking'); ?></h5>
                    ...
                    <div class="group_setting _mar_t_xs">
                        <div class="setting_item">
                            <div class="_fj_between">
                                <span class="abp_label"><?php esc_html_e('Available Color', 'abp-transport-booking'); ?></span>
                                <label>
                        ...
                        <div class="setting_item">
                            <div class="_fj_between">
                                <span class="abp_label"><?php esc_html_e('Sold Color', 'abp-transport-booking'); ?></span>
                                <label>
                        ...
                        <div class="setting_item">
                            <div class="_fj_between">
                                <span class="abp_label"><?php esc_html_e('Booked Color', 'abp-transport-booking'); ?></span>
                                <label>
                        ...
                        <div class="setting_item">
                            <div class="_fj_between">
                                <span class="abp_label"><?php esc_html_e('Selected Color', 'abp-transport-booking'); ?></span>
                                <label>
                                ...
                                if ($is_on || $counter === 0) {
                                    ...
                                    if (!empty($label)) { ?>
                                        <div class="_list_item">
                                            ...
                                            <div class="_group_content">
                                                <button type="button" class="_btn_light_yellow_xxs" onclick="abptb_popup_open_global('ticket_type','<?php echo esc_attr($key); ?>')" title="<?php echo esc_attr__('Edit : ', 'abp-transport-booking') . ' ' . esc_attr($label); ?>"><?php ABPTB_Static::svg('edit'); ?></button>
                                                <button type="button" class="_btn_light_danger_xxs" onclick="abptb_delete_global('ticket_type','<?php echo esc_attr($key); ?>')" title="<?php echo esc_attr__('Trash : ', 'abp-transport-booking') . ' ' . esc_attr($label); ?>"><?php ABPTB_Static::svg('close_1'); ?></button>
                                            </div>
                                        </div>
                                        <?php
                                    }
            ...
            public function add_ticket_type(): void {
                ...
                ?>
                <div class="abp_form">
                    <h5 class="abp"><?php esc_html_e('ADD / Edit Ticket Type', 'abp-transport-booking'); ?></h5>
                    <div class="_divider_xxs"></div>
                    <?php ABPTB_Layout::info_text('ticket_settings'); ?>
                ...
                if (sizeof($options) > 0) { ?>
                    <div class="_group_list">
                        <?php foreach ($options as $key => $item) {
                            ...
                            if (!empty($label)) { ?>
                                <div class="_list_item">
                                    <h6 class="abp_gap_xxs" style="color:<?php echo esc_attr($item['color'] ?? ''); ?>"><?php ABPTB_Layout::image_icon($item['icon'] ?? '');
                                            echo esc_html($label); ?></h6>
                                    <div class="_group_content">
                                        <button type="button" class="_btn_light_yellow_xxs" onclick="abptb_popup_open_global('decor_item')" title="<?php echo esc_attr__('Edit : ', 'abp-transport-booking') . ' ' . esc_attr($label); ?>"><?php ABPTB_Static::svg('edit'); ?></button>
                                        <button type="button" class="_btn_light_danger_xxs" onclick="abptb_delete_global('decor_item','<?php echo esc_attr($key); ?>')" title="<?php echo esc_attr__('Trash : ', 'abp-transport-booking') . ' ' . esc_attr($label); ?>"><?php ABPTB_Static::svg('close_1'); ?></button>
                                    </div>
                                </div>
                            <?php }
                        } ?>
            ...
            public function add_decor_item(): void {
                ...
                $options = ABPTB_Function::get_option('abptb_decor'); ?>
                <div class="abp_form">
                    <h5 class="abp"><?php esc_html_e('Decoration Item List', 'abp-transport-booking'); ?></h5>
                    <div class="_divider_xxs"></div>
