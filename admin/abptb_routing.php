<?php
    ...
    if (!class_exists('ABPTB_Routing')) {
        class ABPTB_Routing {
            public function __construct() {
                add_action('abptb_post_content', [$this, 'routing']);
            }
            public function routing($post_infos = []): void {
                ...
                <div class="tab_item abptb_routing" data-tabs="#abptb_routing">
                    ...
                    <?php ABPTB_Layout::info_text('route_config'); ?>
                    ...
                    <?php if (ABPTB_Function::on_off('pickup')) { ?>
                        <td>
                            <div class="_all_center">
                                <?php ABPTB_Layout::switch_checkbox($prefix.'display_pd[]', ($field['pd'] ?? 'on')); ?>
                            </div>
                        </td>
                    <?php } ?>
