    ...
    if (!class_exists('ABPTB_Category')) {
        class ABPTB_Category {
            ...
            public function global_category(): void {
                if (ABPTB_Function::on_off('category')) {
                    ...
                    <div class="_fj_between_mar_b_xs">
                        <h5 class="abp_gap_xs"><?php ABPTB_Static::svg('category');
            ...
            public function add_tax_category(): void {
                ...
                ?>
                <div class="abp_form">
                    <h5 class="abp_gap_xs"><?php ABPTB_Static::svg('category'); echo esc_html($title); ?></h5>
                                ...
                                <th>
                                    <div class="_fj_center">
                                        <div class="_group_content">
                                            <button type="button" class="_btn_light_yellow_xxs" onclick="abptb_popup_open_global('tax_category','<?php echo esc_attr($term_id); ?>')" title="<?php echo esc_attr__('Edit : ', 'abp-transport-booking') . ' ' . esc_attr($name); ?>"><?php ABPTB_Static::svg('edit'); ?></button>
                                            <button type="button" class="_btn_light_danger_xxs" onclick="abptb_delete_global('tax_category','<?php echo esc_attr($term_id); ?>')" title="<?php echo esc_attr__('Trash : ', 'abp-transport-booking') . ' ' . esc_attr($name); ?>"><?php ABPTB_Static::svg('close_1'); ?></button>
                                        </div>
                                    </div>
                                </th>
                            </tr>
