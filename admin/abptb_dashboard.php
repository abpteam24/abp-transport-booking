	...
	if ( ! class_exists( 'ABPTB_Dashboard' ) ) {
		class ABPTB_Dashboard {
			public function __construct() {
				add_action( 'abptb_load_dashboard', [ $this, 'load_dashboard' ] );
			}

			public function load_dashboard( $abptb_info=[] ): void {
				$total_post     =$abptb_info['total_post'] ?? 0;
				$total_property =  $abptb_info['total_property'] ?? 0;
				?>
                    ...
                    <div class="dashboard_head _f_wrap">
                        <div class="_section_card" data-href="<?php echo esc_url( add_query_arg( 'tab', 'posts' ) ); ?>">
                            <div class="_d_flex">
                                ...
                                <div class="_fd_column">
                                    <h5 class="_abp"><?php esc_html_e( 'Post', 'abp-transport-booking' ); ?></h5>
                        ...
                        <div class="_section_card" data-href="<?php echo esc_url( add_query_arg( 'tab', 'properties' ) ); ?>">
                            <div class="_d_flex">
                                ...
                                <div class="_fd_column">
                                    <h5 class="_abp"><?php esc_html_e( 'Properties', 'abp-transport-booking' ); ?></h5>
