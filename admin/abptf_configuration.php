                ...
                return apply_filters('abptf_configuration_data_filter', array(
                    'abptf_configuration' => apply_filters('abptf_configuration_filter', array(
                        ...
                        array(
                            ...
                            'type' => 'text',
                            'default' => __('Transport', 'abp-transportforge'),
                        ),
                        array(
                            'name' => 'slug',
                        ...
                        array(
                            ...
                            'desc' => __('Select a global FontAwesome vector icon / Emoji to act as the primary visual brand identity throughout the plugin panels.', 'abp-transportforge'),
                            'type' => 'fontawesome',
                            'default' => '🚐'
                        ),
                        array(
                    ...
                    'abptf_on_off' => apply_filters('abptf_on_off_filter', array(
                        ...
                        array(
                            ...
                            'label' => ABPTF_Function::organizer_label(),
                            'desc' => __('If you do not want to display transport capacity across the entire frontend of your site, turn this switch Off. When enabled, you can control the transport capacity display individually for each transport.', 'abp-transportforge'),
                            'type' => 'button_switch',
                            'default' => 'on',
                        ),
                        array(
                            'name' => 'display_location',
                            'label' => __('Route Direction', 'abp-transportforge'),
                            'desc' => __('If you do not want to display route directions across the entire frontend of your site, turn this switch Off.', 'abp-transportforge'),
                            'type' => 'button_switch',
                            'default' => 'on',
                        ),
                        array(
                        ...
                        array(
                            'name' => 'min_max',
                            'label' => __('Min & Max qty', 'abp-transportforge'),
                            'desc' => __('If you do not want to use the Min & Max feature, simply turn this switch OFF. This will completely disable the Transport Min & Max feature for all transports across your website.  You can re-enable the Transport return feature at any time by turning this switch back ON.', 'abp-transportforge'),
                            'type' => 'button_switch',
                            'default' => 'on',
                        ),
                        ...
                        array(
                            'name' => 'capacity',
                            'label' => __('Display Capacity', 'abp-transportforge'),
                            'desc' => __('Turn off this switch to hide the passenger capacity on the frontend across your entire site. Turn it back on at any time to make the passenger capacity visible again.', 'abp-transportforge'),
                            'type' => 'button_switch',
                            'default' => 'on',
                        ),
                        array(
                            'name' => 'custom_attendee',
                            'label' => __('Attendee Form', 'abp-transportforge'),
                            'desc' => __('Control the Attendee Form feature globally. Disable it to turn the feature off for all transports. Enable it to allow each transport to enable or disable the feature individually. You can re-enable this feature at any time by turning this switch back ON.', 'abp-transportforge'),
                            'type' => 'button_switch',
                            'default' => 'on',
                        ),
                        array(
                            'name' => 'same_attendee',
                            'label' => __('Same Attendee', 'abp-transportforge'),
                            'desc' => __('Control the Same Attendee feature globally. Disable it to turn the feature off for all transports. Enable it to allow each transport to enable or disable the feature individually. You can re-enable this feature at any time by turning this switch back ON.', 'abp-transportforge'),
                            'type' => 'button_switch',
                            'default' => 'on',
                            'collapse_data' => array('option' => 'abptf_on_off', 'key' => 'custom_attendee'),
                        ),
                        array(
                            'name' => 'pickup',
            ...
            public function file($option): void {
                ...
                <div class="setting_item <?php echo esc_attr($option['class'] ?? ''); ?>" <?php if (!empty($section_target)) { ?> data-collapse="#<?php echo esc_attr($section_target); ?>"  <?php } ?>>
                    <div class="_f_wrap_fj_between_fa_center">
                        ...
                        <div><?php do_action('abptf_image_selection', ($option['name'] ?? ''), ($option['value'] ?? '')); ?></div>
                    </div>
                    <?php self::description($option); ?>
                </div>
                <?php
